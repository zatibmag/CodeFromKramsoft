...
class SprintStoryFormPreparerTest extends TestCase
{
    private SprintStoryFormPreparer   $formPreparer;
    ...
    protected function setUp(): void
    {
        ...
        $this->formPreparer = new SprintStoryFormPreparer($this->formFactory, $this->requestStack);
    }
    ...
    public function testPrepareForm($entity, $expectedException): void
    {
        ...
        $this->formFactory
            ...
            ->method('create')
            ->with(SprintStoryType::class, $entity, [])
            ->willReturn($form);
    ...
    {
        yield [new SprintStory(), null];
        yield [new Sprint(), EntityNotSupportedException::class];
    }
}
